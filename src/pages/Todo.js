  ...
  const handeleSubmit = (e) => {
    ...
    try {
      ; (
        async () => {
          try {
            const res = await Axios.post("https://todo-node-server-r3eeuwmo1-riteshdhapates-projects.vercel.app//addtodo", { title, massage, completed: false, userid: userdata.user._id });            
            setTitle("");
            setMassage("");
